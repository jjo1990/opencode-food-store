...
export function OrderConfirmation({
  ...
  return (
    <div className={`mx-auto max-w-lg text-center ${className}`}>
      ...
      <h2 className="mb-2 text-2xl font-bold text-gray-900">¡Pedido creado exitosamente!</h2>
      <p className="mb-6 text-gray-500">Tu pedido ha sido registrado y está pendiente de pago.</p>
