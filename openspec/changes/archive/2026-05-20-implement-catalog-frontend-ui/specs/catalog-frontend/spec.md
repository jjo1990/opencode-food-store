# Spec: catalog-frontend

## Overview

Catálogo público de productos con navegación por categorías, filtros (búsqueda, precio, categoría), paginación y detalle de producto. Consume la API pública `GET /api/v1/catalog/productos` y `GET /api/v1/categorias`.
