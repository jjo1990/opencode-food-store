...
Especifica el sistema de logging condicional para desarrollo en el frontend de Food Store. Cubre la utilidad devLogger con guard de modo desarrollo, logging de acciones clave de usuario (auth, cart, payment, orders), logging de requests HTTP en axios interceptor, y disponibilidad de TanStack Query DevTools solo en desarrollo.
