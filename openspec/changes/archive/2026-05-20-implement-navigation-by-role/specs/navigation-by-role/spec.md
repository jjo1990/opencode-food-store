# Spec: navigation-by-role

## Overview

Sistema de navegación que renderiza opciones según los roles del usuario autenticado. Incluye menú contextual en Header, navegación completa en Navigation/Sidebar, lazy loading de módulos por rol, y guards de rutas.
