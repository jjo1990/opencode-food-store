...
Interfaz de gestión de usuarios en el panel de administración. Permite a usuarios con rol ADMIN buscar, filtrar, visualizar, editar, desactivar y reactivar usuarios del sistema a través de una tabla paginada con modales de acción.
