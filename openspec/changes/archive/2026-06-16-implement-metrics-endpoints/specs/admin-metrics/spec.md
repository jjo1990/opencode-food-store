...
Proveer endpoints de agregación para el dashboard administrativo de Food Store. Estos endpoints permiten a los administradores visualizar KPIs generales, tendencias de ventas, productos más vendidos y distribución de pedidos por estado. Todos los endpoints requieren autenticación con rol ADMIN.
