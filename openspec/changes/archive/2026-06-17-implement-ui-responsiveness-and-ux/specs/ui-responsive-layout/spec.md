...
Especifica el layout responsive mobile-first de Food Store. Cubre el Header con hamburger button, el Sidebar con visibilidad responsive (`hidden lg:block`), el MobileDrawer con portal/overlay/slide/Escape/scroll-lock, la integración de Navigation, y la estructura general del Layout.
