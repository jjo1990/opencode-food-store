...
Proveer endpoints y UI administrativa para que usuarios con roles ADMIN y STOCK puedan visualizar y gestionar el catálogo completo (productos, categorías, ingredientes), incluyendo elementos eliminados lógicamente y no disponibles, desde el panel de administración.
